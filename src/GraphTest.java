...
public class GraphTest {
     ...
     */
    @Test 
    public void testFurthestCostAtoE(){
     ...
     */
    @Test
    public void testFurthestPathAtoE(){
    ...
    /**
     * Checks if the predecessor of the last vertex in path F to B is C
     */
    @Test
    public void testPredecessorOfPathFtoB() {
        assertTrue(graph.shortestPath("F", "B").toString().contains("C, B]"));
    }

    /**
     * Checks the distance/total weight cost from the vertex D to C.
     */
    @Test
     ...
     */
    @Test
    public void testFurthestPathBtoF(){
